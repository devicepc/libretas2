  ...
  import {getFirestore, collection, addDoc, getDocs, onSnapshot, deleteDoc, doc, getDoc, updateDoc, query, where } from "https://www.gstatic.com/firebasejs/9.6.4/firebase-firestore.js";
...
export const updateTask2 =(id, newFields) => updateDoc (doc(db, 'Libretas', id), newFields );


  // comparamos los datos con la basde de dats y si es v que los actualice
  // export const updateInsp = 
  // conectamos con la basede datos, en donde queremos guardad y el dato{}
  /* addDoc(collection(db, 'Libretas'),{LibIdentificador, LibCategoria, LibName, LibCedula, LibVto, LibObservaciones, LibPuntos, LibStatus}) 
}
*/
...
const libretasRef = collection(db,"Libretas");
const  IdBUsInsp = document.getElementById('IdBUsInsp').value;
export const LibretasFre2 = query(libretasRef, where("LibretaIdentificador", "==", IdBUsInsp));